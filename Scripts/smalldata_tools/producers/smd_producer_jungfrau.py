...
def getAzIntPyFAIParams(run):
    ...
    if run<0:
        ...
        #az_dict['mask'] = np.load("/sdf/data/lcls/ds/xpp/xppx1003621/results/phsun/results/run320_mask.npy").astype(bool)
        az_dict['npts'] = 512
